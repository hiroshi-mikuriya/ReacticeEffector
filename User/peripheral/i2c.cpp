...
satoh::I2C::Result satoh::I2C::write(uint8_t slaveAddr, uint8_t const *bytes, uint32_t size) const noexcept
{
...
satoh::I2C::Result satoh::I2C::read(uint8_t slaveAddr, uint8_t *buffer, uint32_t size) const noexcept
{
  if (LL_I2C_IsActiveFlag_BUSY(i2cx_))
  {
    return Result::BUSY;
